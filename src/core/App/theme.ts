...
export const lightTheme: DefaultTheme = {
    ...
    color: {
        ...
        textHover: colorNames.scienceBlue,
        ...
        repoTitle: colorNames.scienceBlue,
        ...
        repoLinkHover: colorNames.dodgerBlue,
        buttonText: colorNames.white,
        buttonBackground: colorNames.scienceBlue,
        buttonBackgroundHover: colorNames.dodgerBlue,
        ...
        socialIconBackgroundHover: colorNames.scienceBlue,
        loaderBackground: colorNames.iron30percent,
        loaderFront: colorNames.scienceBlue
    }
}
...
export const darkTheme: DefaultTheme = {
    ...
    color: {
        ...
        repoTitle: colorNames.dodgerBlue,
        repoShadow: colorNames.violet2percent,
